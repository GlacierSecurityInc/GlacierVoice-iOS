...
def basic_pods
	if ENV['PODFILE_PATH'].nil?
      pod 'linphone-sdk/basic-frameworks', '4.4.0'
		else
...
def ext_pods
	if ENV['PODFILE_PATH'].nil?
      pod 'linphone-sdk/app-extension-swift', '4.4.0'
		else
      pod 'linphone-sdk/app-extension-swift', :path => ENV['PODFILE_PATH']  # local s
	end
