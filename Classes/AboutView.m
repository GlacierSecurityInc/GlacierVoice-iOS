...
- (void)viewDidLoad {
    ...
    if (default_proxy != NULL) {
        ...
        NSString *dname = [NSString stringWithUTF8String:linphone_address_get_display_name(linphone_proxy_config_get_identity_address(default_proxy))];
        _nameLabel.text = [NSString stringWithFormat:@"Display Name: %@", dname];
