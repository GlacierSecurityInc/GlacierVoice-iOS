...
- (void)loadData {
	...
	while (logs != NULL) {
		...
		if (!missedFilter || linphone_call_log_get_status(log) == LinphoneCallMissed ||
            (linphone_call_log_get_dir(log) == LinphoneCallIncoming && linphone_call_log_get_status(log) == LinphoneCallAborted)) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	tempLabel.textColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"color_Gl.png"]]; 
